...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=DESKTOP-4FPTIJJ;Database=AirplaneSystem;Trusted_Connection=True; Encrypt=False;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Airplane>(entity =>
        {
            entity.HasKey(e => e.AirplaneId).HasName("PK__Airplane__5ED76B8559E49F53");
        ...
        {
            entity.HasKey(e => e.FlightId).HasName("PK__Flight__8A9E148E8FA1D06B");
        ...
        {
            entity.HasKey(e => e.PassengerId).HasName("PK__Passenge__88915F90B42E6CAE");
        ...
        {
            entity.HasKey(e => e.PilotId).HasName("PK__Pilot__B305516DB53D93C9");
        ...
        {
            entity.HasKey(e => e.ReservationId).HasName("PK__Reservat__B7EE5F048A764BFC");
